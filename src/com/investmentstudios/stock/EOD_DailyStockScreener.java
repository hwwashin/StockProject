...
public class EOD_DailyStockScreener extends EOD_Code {
	...
	public static void main(String[] args) throws IOException {
		...
		setDayInfo(args, "02", "10", "2017", "Monday");  // !!!! DAY  MONTH  Year  DayOWeek
		setEODDirectories();
...
//			eodscreened[i] = eodstockoutput[i] + "," + "0" + "," + "1" + "," + yearlow[i];	
...
//		titlestring = "Date,Open,High,Low,Close,Volume,AdjClose,Stock,Exchange,Dividend,Split,52WkLo";
		saveEODScreenData(); 
